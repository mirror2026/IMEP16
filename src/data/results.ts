    ...
    characters: [
      {
        code: 'TSLO',
        title: '无情满绩卷王',
        mbti: 'INTJ 或极度自律的 ISTJ',
        career: '【考研圣体】 985学硕、定向选调生。研Bot 提醒：不要在乎报录比，你的对手只有你自己。',
        partner: 'PSLO (体制内隐形人)。两人可以坐在图书馆一天不互说一句话，但配合极其默契。',
        rival: 'PRGC (风口交际牛马)。你觉得ta吵闹且没逻辑，ta觉得你像个没有感情的做题机器。',
      },
      {
        code: 'TSLC',
        title: '薛定谔的学霸',
        mbti: 'INTP（日常摸鱼，考前超神）',
        career: '【考前突击的神】 考研本校保底，或去国企研究所。研Bot 提醒：别报竞争太惨烈的，小心最后关头心态崩。',
        partner: 'PSLC (极限捡漏大师)。两人可以一起研究怎么用最少的分数考上性价比最高的学校。',
      ...
      },
      {
        ...
        partner: 'TSLO (无情满绩卷王)。你负责搜集网课和真题，ta 负责给你讲题，强强联合。',
        rival: 'TRLC (午夜学术疯子)。ta 那些天马行空的理论在你看来毫无应试价值。',
      },
      {
        code: 'TSGC',
        title: '群聊焦虑传播者',
        mbti: 'ESFJ（一边焦虑一边吃瓜）',
        career: '【考研气氛组】考研气氛组，最终大概率走秋招去传统行业。',
    ...
    characters: [
      {
        ...
        title: '体制内隐形人',
        mbti: 'ISTJ（无情的打卡机器）',
        career: '【闷声考公王】考公、国企、银行。不适合卷考研，去社会上混口稳当饭最香。',
        partner: 'TSLO (无情满绩卷王)。各卷各的，互不打扰。',
        rival: 'TRGC (赛博街溜子)。你完全无法理解 ta 为什么每天都在折腾没用的东西。',
      },
      {
        code: 'PSLC',
        title: '极限捡漏大师',
        mbti: 'ISTP（实用主义，绝不多花一分力气）',
        career: '【调剂区战神】研Bot 调剂大户、边缘冷门专业、或者回老家考个编。',
      ...
      },
      {
        ...
        partner: 'TRGO (PPT画饼导师)。ta 负责在台上吹牛画大饼，你负责在台下把活干完。',
        rival: 'TRLC (午夜学术疯子)。你觉得 ta 不切实际且极度不配合团队工作。',
      },
      {
        code: 'PSGC',
        title: '快乐的混子',
    ...
    characters: [
      {
        ...
        rival: 'PSGC (快乐的混子)。人类的悲欢并不相通，你觉得 ta 浪费空气。',
      },
      {
        code: 'TRLC',
        title: '午夜学术疯子',
        mbti: 'INFP 或 ENTP（脑洞大开，极其浪漫或极其疯癫）',
        career: '【灵感流哲学家】申请海外名校 MFA/Ph.D、艺术创作者。国内的考研报录比配不上你的才华。',
        partner: 'TRGC (赛博街溜子)。两个疯子可以一起碰撞出改变世界的（或者纯搞笑的）点子。',
      ...
      },
      {
        ...
        rival: 'TSLC (薛定谔的学霸)。ta 一眼就能看穿你的 PPT 里全是虚的，并且当众拆穿你。',
      },
      {
        code: 'TRGC',
        title: '赛博街溜子',
        mbti: 'ENFP（快乐的小蝴蝶，思维极其跳跃）',
        career: '【每天一个新想法】 自媒体博主、留学Gap Year、或者每年换一个赛道。',
        partner: 'TRLC (午夜疯子)。精神状态完美契合。',
        rival: 'TSLO (无情卷王)。看到 ta 那密密麻麻的日程表，你只会觉得头皮发麻。',
      },
    ],
  },
  {
    ...
    characters: [
      {
        ...
        title: '独狼搞钱机',
        mbti: 'ISTP 或 ENTJ',
        career: '【闷声干大事的狠人】 大厂核心技术/业务线、直接创业。研Bot 警告：读研会严重影响你的搞钱速度。',
      ...
      },
      {
        ...
        title: '风口交际牛马',
        mbti: 'ENTP 或 ESFP',
        career: '【哪里热闹去哪里】 广告传媒、公关 PR、MCN 机构商务。',
...
const heartfeltNoteByCode: Record<string, string> = {
  ...
  TSGO:
    '群里有人求助，你总是第一时间响应；你照顾身边所有人的情绪，却唯独总是委屈了自己。你太害怕让别人失望，以至于把别人的期待当成了自己的坐标。在这场名为成长的单人赛里，研Bot 希望你能“自私”一点。学会课题分离，把你给别人的耐心分一半给那个同样疲惫的自己。你不需要通过“被需要”来证明价值，你本身就值得被爱。',
  TSGC:
  ...
  TRLC:
    '你的灵魂浪漫、跳跃、充满理想主义。正因如此，当面对僵硬的考试大纲和枯燥的报录比时，你感受到的痛苦比任何人都深烈。你容易觉得这个功利的系统配不上你的才华。但请记住，现实不是用来妥协的，而是用来跨越的。不要让这份才华在抱怨中消磨，找到那个能承载你灵感的现实容器，用世俗的盾牌，保护好你理想的矛。',
  TRGO:
  ...
  PRGO:
    '卷王之王，永远在打鸡血。你把自我价值深度绑定在 Title、绩效和别人的赞美上，就像在跑步机上狂奔，不敢有丝毫懈怠。停下来！研Bot 真的希望你能停下来深呼吸。你的价值不需要靠永远的“第一名”来维系。即使你今天什么宏伟的目标都没有完成，哪怕只是躺在床上发呆，你依然是一个极其优秀、值得被深爱的人。休息，是你的基本人权。',
  PRGC:
